...
<div class="user-profile">
   ...
   <div class="flex">
      ...
      <a href="../website/addproduct.php" class="option-btn">Add Products</a>
      <a href="../website/login.php?php echo $user_id; ?>" onclick="return confirm('are your sure you want to logout?');" class="delete-btn">logout</a>
   </div>
